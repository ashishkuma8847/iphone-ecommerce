                ...
                <section className="xl:pb-[140px] sm:pb-[80px] pb-[80px] relative">
                    <div className="container  flex flex-col xl:gap-[140px] sm:gap-[80px] gap-[80px] ">
                        <div className="flex sm:flex-col flex-col xl:flex-row sm:gap-[24px] gap-[24px] xl:gap-0  xl:justify-between sm:justify-center  justify-center ">
                            ...
                            <div className={`sm:bg-bottom  max-w-[570px] w-full pl-[32px] pb-[32px] sm:h-[500px] h-[400px] bg-top bg-cover xl:h-[600px] bg-black rounded  bg-no-repeat flex sm:m-auto m-auto xl:m-0  bg-[url('/src/assets/images/ps5.png')]`} >
                            ...
                            <div className="flex flex-col justify-between sm:gap-[24px] gap-[24px] xl:gap-0">
                                <div className="flex sm:m-auto m-auto xl:m-0">
                                    <div className={`pl-[24px] pb-[24px] sm:w-[570px] sm:h-[286px] w-[335px] h-[286px] bg-[#0D0D0D]  bg-left  sm:bg-right rounded bg-no-repeat  bg-[url('/src/assets/images/woman-character.png')]`} >
                                ...
                                <div className="flex sm:flex-row flex-col  xl:justify-between sm:gap-[30px] gap-[30px] xl:gap-0 sm:m-auto m-auto xl:m-0">
                                    <div className="flex">
                                    <div className={` pl-[24px] pb-[24px] w-[335px] h-[284px] sm:w-[270px] sm:h-[284px] bg-[#242424]  bg-center rounded bg-no-repeat  bg-[url('/src/assets/images/speacer.png')]`} >
                                    ...
                                    <div className="flex">
                                    <div className={` pl-[24px] pb-[24px] w-[335px] h-[284px] sm:w-[270px] sm:h-[284px] bg-[#242424]  bg-center rounded bg-no-repeat  bg-[url('/src/assets/images/perfume.png')]`} >
                                        <div className={` w-[242px] gap-[8px]  flex h-full flex-col   justify-end`}>
                                            <h2 className="text-[#FAFAFA] font-semibold xl:text-2xl font-customfont leading-6 tracking-[0.03em]">
                                            Perfume
                                            </h2>
