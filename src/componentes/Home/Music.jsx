...
>
            <div className="flex max-w-[499px] sm:gap-[24px] gap-[24px] lg:gap-[32px] w-full  flex-col">
              <h4 className="font-customfont12 text-customgreen-0 leading-[20px] font-semibold text-base">
                Categories
              </h4>
              <h1 className="font-semibold font-customfont lg:text-5xl leading-[60px] tracking-[0.04em] max-w-[443px] sm:text-3xl text-3xl w-full">
                  ...
                  <div key={index + Date.now() + item}>
                    <Link to={item.to}>
                      <div className="flex items-center justify-center pt-[11px]  pb-[11px] flex-col w-[62px] rounded-[100%] bg-white text-black">
                        <h4 className="font-customfont12 font-semibold text-base leading-[20px  ]">
                          {item.name}
                        </h4>
                        <h4 className="font-customfont12 font-normal text-[11px]  leading-[18px  ]">
                          {item.font}
                        </h4>
                      </div>
                    </Link>
              ...
              <Link to={"/checkout"} className="pt-[8px]">
                <Button
                  variant={"solid"}
                  className={
                    "bg-customgreen-0 w-[173px]  hover:border-customgreen-0 hover:text-customgreen-0"
                  }
                  children={"Buy Now!"}
                />
              </Link>
            ...
            >
              <img
                className=" sm:h-[330px] max-h-200px] h-full max-w-[468px] w-full sm:w-[568px] drop-shadow-custom12  "
                src="/assets/images/musicbox.png"
                alt="box"
              />
            </motion.div>
          </div>
