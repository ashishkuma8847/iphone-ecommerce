...
const Banner = () => {
    ...
    return (
                ...
                <div className="bannerr flex  
                 ...
                 sm:h-[100px] sm:mt-5   sm:overflow-auto lg:overflow-hidden lg:w-[217px]">
                   ...
                   lg:text-base lg:leading-[24px] lg:w-[214px] lg:pb-4
                     hover:text-CustomRed-0 transition-all duration-300 font-customfont12  justify-between items-center  font-normal  "
                                >
                                    ...
                                    <img
                                        ...
                                        className={`transition-all duration-300 ${rotate && "rotate-90 "
                                            } `}
                                        alt="image for arrow"
                                    />
                                </button>
                    ...
                    transition-all duration-300 ${rotate ? "sm:h-[30px] lg:h-[120px] opacity-100 z-10" : "h-0 opacity-0 "
                  ...
                  hover:text-CustomRed-0 transition-all duration-300 font-customfont12 justify-between items-center  "
                                >
                                    ...
                                    <img
                                        ...
                                        className={`transition-all duration-300 ${rotate1 && "rotate-90"
                                            } `}
                                        alt="image for arrow"
                                    />
                                </button>
                   ...
                   lg:text-base lg:leading-[24px] lg:w-full lg:pb-4 lg:flex lg:flex-col lg:justify-start lg:items-start
                    transition-all relative duration-300 marker:text-gray-300 font-customfont12  ${rotate1
                                ...
                                <div className={` font-customfont12  sm:flex-col
        ...
        block w-[1px]  h-[384px] bg-[#b2b2b270] ml-4 mr-[45px]  "></span>
                <div className="flex 
                lg:mt-10 
                sm:mt-5 
                                    ...
                                    <Link to={item.to} className="flex justify-between">
                                        <div className="lg:pl-16  lg:pt-[58px] sm:pl-8 sm:pt-[28px] sm:pb-[28px]">
                                            <ul className="lg:mb-5 sm:mb-4  flex items-center w-[190px] lg:gap-[24px]  sm:gap-[12px] font-customfont12">
                                                <img className="lg:w-[40px] lg:h-[49px]
                                                sm:w-[34px] sm:h-[34px]
                                                " src={item.img1} alt="" />
                                                <li className="font-normal lg:text-base  sm:text-xs lg:leading-6
                                                sm:leading-5
                                                ">
                                                    {item.name}
                                                </li>
