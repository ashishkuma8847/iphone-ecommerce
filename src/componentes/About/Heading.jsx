  ...
  return (
    <main className="xl:pt-[80px] xl:pb-[140px] sm:pt-[40px] pt-[40px] sm:pb-[80px] pb-[80px]">
      ...
      <div className="flex xl:flex-row sm:flex-col-reverse flex-col-reverse xl:gap-[75px] sm:gap-6 gap-6 justify-center items-center xl:pb-[140px] sm:pb-[80px] pb-[80px]">
        <div className="flex flex-col p-[0px_24px] sm:p-0 xl:gap-10 sm:gap-6 gap-6 ">
        ...
        <img className="xl:max-w-[705px] xl:w-full xl:max-h-[609px] xl:h-full sm:w-[500px] w-[400px] sm:h-[400px] h-[350px] " src="/src/assets/images/charatertwo.png" alt="Character Illustration" />
      </div>
